  ...
  return (
    <div className="relative" ref={panelRef}>
      <button
        ...
        className="relative p-2 text-muted hover:text-main transition-colors rounded-lg hover:bg-subtle"
        aria-label="Notifications"
      >
        <Bell size={18} />
        {unreadCount > 0 && (
          <span className="absolute top-1 right-1 min-w-[16px] h-4 px-1 flex items-center justify-center text-[10px] font-bold text-main bg-red-500 rounded-full border border-[#030304]">
      ...
      {open && (
        <div className="absolute right-0 top-full mt-2 w-[360px] max-h-[420px] flex flex-col rounded-xl border border-subtle bg-card shadow-2xl z-50 overflow-hidden animate-in fade-in slide-in-from-top-2 duration-200">
