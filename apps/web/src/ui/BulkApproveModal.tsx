    ...
    <div className="modal-overlay" style={{ zIndex: 9999 }} onClick={(e) => e.target === e.currentTarget && onClose()}>
      <div className="modal-content w-full max-w-lg p-6 bg-[#121214] border border-subtle rounded-2xl shadow-2xl">
        <div className="flex items-start justify-between gap-4 mb-6">
          <div>
            <h2 className="text-xl font-semibold text-main tracking-tight">Confirm Bulk Approval</h2>
            <p className="mt-1 text-sm text-muted">You are about to approve {docs.length} document{docs.length !== 1 ? 's' : ''}.</p>
          </div>
        ...
        <div className="rounded-xl border border-subtle bg-subtle p-5">
          <p className="text-sm font-semibold text-main mb-3">Risk Summary</p>
        ...
        <div className="mt-6 flex justify-end gap-3 pt-4 border-t border-subtle">
